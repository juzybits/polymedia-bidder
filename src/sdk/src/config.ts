...
export const AUCTION_ERRORS: Record<number, string> = {
    ...
    5011: "E_ITEM_LENGTH_MISMATCH",
    5012: "E_NOT_ENOUGH_ITEMS",
    5013: "E_TOO_MANY_ITEMS",
    5014: "E_MISSING_ITEM",
    5015: "E_DUPLICATE_ITEM_ADDRESSES",
...
export const AUCTION_IDS: Record<NetworkName, NetworkConfig> = {
    ...
    devnet: {
        packageId: "0x739c55efaf4bec17c0d4e943b575e9ce6b470d02195dbe920dc6460bef3f9e89",
        registryId: "0x99184628bccf415e8664bce7754a36f097f8650969173504e60a1e78299571fb",
    },
    localnet: {
